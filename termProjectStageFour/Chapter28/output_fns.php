...
?>
 ...
 <table bgcolor="#cccccc">
   <tr>
     <td>Username:</td>
     <td><input class="ch" type="text" name="username"/></td></tr>
   <tr>
     <td>Password:</td>
     <td><input class="ch" type="password" name="passwd"/></td></tr>
   <tr>
     <td colspan="2" align="center">
     <input class="ch" type="submit" value="Log in"/></td></tr>
   <tr>
 </table></form>
<?php
}
...
<a href="booklistbycategory.php">Book List by Category</a><br />
<?php
}
