...
.ch {
  ...
  <tr>
    <td>Category Name:</td>
    <td><input class="ch" type="text" name="catname" size="40" maxlength="40"
...
.ch {
  ...
  <tr>
    <td>ISBN:</td>
    <td><input class="ch"  type="text" name="isbn"
         value="<?php echo $edit ? $book['isbn'] : ''; ?>" /></td>
  </tr>
  <tr>
    <td>Book Title:</td>
    <td><input class="ch"  type="text" name="title"
         value="<?php echo $edit ? $book['title'] : ''; ?>" /></td>
  </tr>
  <tr>
    <td>Book Author:</td>
    <td><input class="ch"  type="text" name="author"
         value="<?php echo $edit ? $book['author'] : ''; ?>" /></td>
   </tr>
   <tr>
      <td>Category:</td>
      <td><select class="ch"  name="catid">
      <?php
   ...
   <tr>
    <td>Price:</td>
    <td><input class="ch"  type="text" name="price"
               value="<?php echo $edit ? $book['price'] : ''; ?>" /></td>
   </tr>
   <tr>
     <td>Description:</td>
     <td><textarea class="ch"  rows="3" cols="50"
...
.ch {
   ...
   <tr><td>Old password:</td>
       <td><input class="ch" type="password" name="old_passwd" size="16" maxlength="16" /></td>
   </tr>
   <tr><td>New password:</td>
       <td><input class="ch" type="password" name="new_passwd" size="16" maxlength="16" /></td>
   </tr>
   <tr><td>Repeat new password:</td>
       <td><input class="ch"  type="password" name="new_passwd2" size="16" maxlength="16" /></td>
   </tr>
   <tr><td colspan=2 align="center"><input class="ch" type="submit" value="Change password">
   </td></tr>
   </table>
   <br />
<?php
